...
public class Hamburger extends Product {
    ...
    public Hamburger(int idRestaurant){
        super(idRestaurant);
    }
    ...
    public Hamburger(Product product, boolean containsSalt, boolean containsSesame, boolean containsPepper, boolean containsFries, boolean containsOnion, boolean containsTomato, boolean containsLettuce, boolean containsCheese, boolean containsPickles) {
        super(product);
