...
public class Shaorma extends Product {
    ...
    public Shaorma(int idRestaurant){
        super(idRestaurant);
    }
    ...
    public Shaorma(Product product, boolean containsSalt, boolean containsFries, boolean containsOnion, boolean containsTomato, boolean containsLettuce, boolean containsPickles, boolean containsParsley, boolean containsKetchup, boolean containsMayonnaise) {
        super(product);
