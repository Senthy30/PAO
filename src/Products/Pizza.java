...
public class Pizza extends Product {
    ...
    public Pizza(int id, int idRestaurant){
    ...
    public Pizza(Product product, int idPizza, int idProduct, boolean containsSalt, boolean containsMozzarella, boolean containsTomato, boolean containsPepperoni, boolean containsMushrooms, boolean containsOlives, boolean containsOnion) {
        super(product);
