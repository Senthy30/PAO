...
import Repositories.Products.PizzaRepository;
...
public class PizzaService implements PizzaServiceInterface {
    ...
    public Pizza GetPizzaById(int id) {
        return pizzaRepository.Select(id);
    }
    ...
    public int ReadNewPizza(Product product) throws IOException {
        ...
        int id = pizzaRepository.GetIdCounter();
        Pizza pizza = new Pizza(product, id, product.GetId(), containsSalt, containsMozzarella, containsTomato, containsPepperoni, containsMushrooms, containsOlives, containsOnion);
